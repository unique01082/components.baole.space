...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    const statusStyles = {
      ...
      error:
        "border-[var(--color-border-error)] focus:border-[var(--color-border-error)]",
      success:
        "border-[var(--color-border-success)] focus:border-[var(--color-border-success)]",
      warning:
        "border-[var(--color-border-warning)] focus:border-[var(--color-border-warning)]",
    };
