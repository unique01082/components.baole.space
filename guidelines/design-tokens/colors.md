...
@baolq/ui is **dark-first** with glassmorphism surfaces and gradient accents. The color system embodies the baole.space visual identity: creative, energetic, polished — never corporate or cold.
...
Gradients are the signature visual element of @baolq/ui.
