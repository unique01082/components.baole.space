...
@baolq/ui uses Tailwind CSS v4's default 4px-base spacing scale with two additional semantic tokens for layout-level spacing. The goal is **generous whitespace at macro (section/page) level, tight precision at micro (component) level**.
...
Full 4px-base scale used throughout @baolq/ui (Tailwind defaults):
...
@baolq/ui follows Tailwind's default breakpoint system:
