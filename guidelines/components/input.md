...
The Input component is a styled text input field with support for labels, helper text, error states, prefixes/suffixes, and icons. It wraps the native `<input>` element with @baolq/ui's glassmorphism styling.
