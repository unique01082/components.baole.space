...
```tsx
import { Avatar, AvatarImage, AvatarFallback, Badge } from '@baolq/ui'
...
import { Button, Badge } from '@baolq/ui'
...
```tsx
import { Table, TableBody, TableRow, TableCell, Badge } from '@baolq/ui'
...
<div className="flex items-center gap-2">
  <h1 className="text-2xl font-bold">@baolq/ui</h1>
