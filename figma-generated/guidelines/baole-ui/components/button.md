...
The Button component is the primary action trigger in the @baole/ui system, supporting 7 visual variants, 6 sizes, loading states, and icon placement with full accessibility.
...
```tsx
import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogCancel, AlertDialogAction, Button } from '@baole/ui'
