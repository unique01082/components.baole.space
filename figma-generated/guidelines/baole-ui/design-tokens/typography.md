...
@baole/ui uses a **two-font system** that balances personality with legibility:
...
When consuming `@baole/ui`, load the fonts in your app's HTML `<head>`:
...
Gradient text is the signature @baole/ui heading treatment for hero sections and primary headings.
