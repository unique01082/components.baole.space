# @baole/ui Quick Start Guide

Get up and running with @baole/ui in 5 minutes.
...
npm install @baole/ui lucide-react

# Or with pnpm
pnpm add @baole/ui lucide-react

# Or with yarn
yarn add @baole/ui lucide-react
```
...
If you're using Tailwind CSS in your project, extend your config with the @baole/ui preset:
...
export default {
  ...
  content: [
    './src/**/*.{ts,tsx}',
    // Include @baole/ui components in scan
    './node_modules/@baole/ui/dist/**/*.{js,ts,jsx,tsx}',
  ],
} satisfies Config
```
...
@baole/ui is designed for dark backgrounds. Wrap your app with the signature gradient:
...
```tsx
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Button, Badge } from '@baole/ui'
...
```tsx
import { Input, Button, Card, CardHeader, CardTitle, CardContent } from '@baole/ui'
...
```tsx
import { Button } from '@baole/ui'
import { Card, CardHeader, CardTitle } from '@baole/ui'
...
```tsx
import { Card, CardHeader, CardTitle, CardContent, Badge } from '@baole/ui'
...
```tsx
import { Button, Skeleton, Card, CardHeader, CardContent } from '@baole/ui'
import { useState } from 'react'
...
All @baole/ui components follow accessibility best practices:
