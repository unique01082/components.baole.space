...
@baole/ui uses **Lucide React** as the icon library. Lucide provides 1000+ consistent, customizable icons with a simple API.
...
Lucide React is a peer dependency of @baole/ui. Install it in your project:
...
## Usage with @baole/ui Components
...
```tsx
import { Sidebar, SidebarMenuItem, SidebarMenuButton } from '@baole/ui'
...
Based on @baole/ui component usage:
