...
3. **Plan Your Implementation**
   ...
   - Always prefer @baole/ui components over plain HTML or raw Tailwind
...
5. **Write Code**
   - Import components: `import { Button, Card, Input } from '@baole/ui'`
   - Import styles in app root: `import '@baole/ui/style.css'`
...
### IMPORTANT — Always Prefer @baole/ui Components
...
- ✅ **DO** use @baole/ui components for all UI elements
...
// Import components
import { Button, Card, Input, Dialog, Badge } from '@baole/ui'
...
import { Form, FormField, FormItem, FormLabel, FormControl, FormMessage, Input, Button } from '@baole/ui'
...
```tsx
import { Command, CommandDialog, CommandInput, CommandList, CommandItem } from '@baole/ui'
