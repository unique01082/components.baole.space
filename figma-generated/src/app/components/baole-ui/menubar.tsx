...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-11 items-center space-x-1 rounded-lg border border-[var(--color-border)] p-1",
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:bg-[var(--color-bg-glass-hover)]",
      "data-[state=open]:bg-[var(--color-bg-glass-hover)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-[var(--color-border)] p-1",
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[12rem] overflow-hidden rounded-lg border border-[var(--color-border)] p-1",
          "bg-[var(--color-popover)] backdrop-blur-[var(--blur-glass)]",
          "text-[var(--color-text)] shadow-[var(--shadow-glass)]",
